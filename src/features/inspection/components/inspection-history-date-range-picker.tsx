// features/plant/components/inspection-history-date-range-picker.tsx
"use client";
...
import { useInspectionHistoryFilters } from "../utils/inspection-history";
...
export function InspectionHistoryDateRangePicker() {
  const [isPending, startTransition] = useTransition();
  const [{ from, to }, setFilters] = useInspectionHistoryFilters({
    startTransition,
  });
