// src/features/dashboard/components/equipments-overview-skeleton.tsx
import { Skeleton } from "@/components/ui/skeleton";
import { Card, CardContent, CardHeader } from "@/components/ui/card";

export function EquipmentsOverviewSkeleton() {
  return (
    <div className="flex flex-col gap-6">
      <StatCardsSkeleton />
      <EquipmentDataTableSkeleton />
    </div>
  );
}
...
function EquipmentDataTableSkeleton() {
  return (
