...
import { EquipmentStatusHistoryPoint } from "../actions/equipment-detail";
...
interface EquipmentStatusHistoryChartProps {
  data: EquipmentStatusHistoryPoint[];
}

export function EquipmentStatusHistoryTrendChart({
  data,
        ...
        <div className="flex flex-1 flex-col justify-center gap-1  pt-4 pb-3 sm:py-0!">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Status recorded at each inspection over time
              </CardDescription>
            </div>
